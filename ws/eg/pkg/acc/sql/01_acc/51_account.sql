...
CREATE OR REPLACE FUNCTION account_password_change_own(a_id ws.d_id, a_psw_old acc.d_password, a_psw_new acc.d_password, a_psw_new_repeat acc.d_password) RETURNS BOOLEAN VOLATILE LANGUAGE 'plpgsql' AS
$_$
-- a_id:               ID Пользователя
